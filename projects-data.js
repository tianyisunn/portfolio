...
{//retellings
  ...
  facts: [
    { 
      label: "Project URL", 
      value: '<a href="https://ldulski.github.io/cs7026-group7/pages/index.html" target="_blank" style="color:#2f80ff; text-decoration:underline; font-weight:600;">Live Preview ↗</a>' 
    },
    { 
      label: "Github", 
      value: '<a href="https://github.com/ldulski/cs7026-group7" target="_blank" style="color:#2f80ff; text-decoration:underline; font-weight:600;">View Repository ↗</a>' 
    },
    { label: "Tech Stack", value: "Vanilla JS (ES6), OpenWeather API, LocalStorage" },
  ],
  boards: [], 
